# game/ai/engines/openspiel_engine.py
...
def compute_ai_move(
    ...
    """
    Placeholder until OpenSpiel integration:
    - random legal move
    """
    n = len(board)
...
# ✅ ALIAS (si ton code attend get_openspiel_move)
def get_openspiel_move(board, difficulty="standard", current_player=-1):
